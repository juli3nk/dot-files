...
ln -s $PWD/"Font-Awesome/use-on-desktop/Font Awesome 6 Free-Solid-900.otf" $fontdir/
ln -s $PWD/"Font-Awesome/use-on-desktop/Font Awesome 6 Free-Regular-400.otf" $fontdir/
ln -s $PWD/"Font-Awesome/use-on-desktop/Font Awesome 6 Brands-Regular-400.otf" $fontdir/

# Ionicons
git clone --depth 1 https://github.com/ionic-team/ionicons
#cp ionicons/docs/fonts/ionicons.ttf $fontdir/
